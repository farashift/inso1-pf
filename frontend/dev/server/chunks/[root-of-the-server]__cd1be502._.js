...
async function POST(request) {
    try {
        ...
        const existingAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].admin.findUnique({
            where: {
                email
            }
        });
        ...
        // Create new admin
        const newAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].admin.create({
            data: {
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd1be502._.js.map